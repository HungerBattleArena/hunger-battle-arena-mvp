...
- Players fight inside an arena to survive.
- Viewers can influence the match in real time by dropping:
  - Items
  - Buffs
  - Debuffs
- This creates chaotic, interactive, and highly viral gameplay.
...
- Performance and UI are subject to change.
